...
function Overview({ data,mode }: { data: any,mode:string }) {
    ...
    return (
        <div className={clsx(`w-full h-[330px] rounded-[30px] flex flex-col items-center justify-around ${mode == "light" ? 'bg-[#D9D9D9]':'bg-[#444]'}`, mode=="light" ? style.box_shadow_light : style.box_shadow_dark)}>
